...
description: "This skill should be used when the user needs the imported Scenario Marketing Campaign specialization. Original scope: Imported from scenario-marketing-campaign.md"
---
...
Provide the imported `Scenario Marketing Campaign` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from scenario-marketing-campaign.md`
- Source file: `strategy/runbooks/scenario-marketing-campaign.md`
