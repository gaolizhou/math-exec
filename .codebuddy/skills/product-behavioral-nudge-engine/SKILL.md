...
description: "This skill should be used when the user needs the imported Behavioral Nudge Engine specialization. Original scope: Behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and success."
---
...
Provide the imported `Behavioral Nudge Engine` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `product/product-behavioral-nudge-engine.md`
