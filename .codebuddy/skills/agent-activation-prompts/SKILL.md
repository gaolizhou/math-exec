...
description: "This skill should be used when the user needs the imported Agent Activation Prompts specialization. Original scope: Imported from agent-activation-prompts.md"
---
...
Provide the imported `Agent Activation Prompts` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from agent-activation-prompts.md`
- Source file: `strategy/coordination/agent-activation-prompts.md`
