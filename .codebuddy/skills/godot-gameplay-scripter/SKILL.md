...
description: "This skill should be used when the user needs the imported Godot Gameplay Scripter specialization. Original scope: Composition and signal integrity specialist - Masters GDScript 2.0, C# integration, node-based architecture, and type-safe signal design for Godot 4 projects"
---
...
Provide the imported `Godot Gameplay Scripter` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/godot/godot-gameplay-scripter.md`
