...
description: "This skill should be used when the user needs the imported MCP Builder specialization. Original scope: Expert Model Context Protocol developer who designs, builds, and tests MCP servers that extend AI agent capabilities with custom tools, resources, and prompts."
---
...
Provide the imported `MCP Builder` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/specialized-mcp-builder.md`
