...
description: "This skill should be used when the user needs the imported Scenario Startup Mvp specialization. Original scope: Imported from scenario-startup-mvp.md"
---
...
Provide the imported `Scenario Startup Mvp` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from scenario-startup-mvp.md`
- Source file: `strategy/runbooks/scenario-startup-mvp.md`
