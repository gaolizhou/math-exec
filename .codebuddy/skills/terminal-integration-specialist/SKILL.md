...
description: "This skill should be used when the user needs the imported Terminal Integration Specialist specialization. Original scope: Terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications"
---
...
Provide the imported `Terminal Integration Specialist` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `spatial-computing/terminal-integration-specialist.md`
