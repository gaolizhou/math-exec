...
description: "This skill should be used when the user needs the imported Game Audio Engineer specialization. Original scope: Interactive audio specialist - Masters FMOD/Wwise integration, adaptive music systems, spatial audio, and audio performance budgeting across all game engines"
---
...
Provide the imported `Game Audio Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/game-audio-engineer.md`
