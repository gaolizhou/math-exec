...
description: "This skill should be used when the user needs the imported XR Immersive Developer specialization. Original scope: Expert WebXR and immersive technology developer with specialization in browser-based AR/VR/XR applications"
---
...
Provide the imported `XR Immersive Developer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `spatial-computing/xr-immersive-developer.md`
