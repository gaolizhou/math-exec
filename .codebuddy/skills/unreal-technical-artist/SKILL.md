...
description: "This skill should be used when the user needs the imported Unreal Technical Artist specialization. Original scope: Unreal Engine visual pipeline specialist - Masters the Material Editor, Niagara VFX, Procedural Content Generation, and the art-to-engine pipeline for UE5 projects"
---
...
Provide the imported `Unreal Technical Artist` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/unreal-engine/unreal-technical-artist.md`
