...
description: "This skill should be used when the user needs the imported Inclusive Visuals Specialist specialization. Original scope: Representation expert who defeats systemic AI biases to generate culturally accurate, affirming, and non-stereotypical images and video."
---
...
Provide the imported `Inclusive Visuals Specialist` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `design/design-inclusive-visuals-specialist.md`
