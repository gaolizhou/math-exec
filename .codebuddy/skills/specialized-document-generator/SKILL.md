...
description: "This skill should be used when the user needs the imported Document Generator specialization. Original scope: Expert document creation specialist who generates professional PDF, PPTX, DOCX, and XLSX files using code-based approaches with proper formatting, charts, and data visualization."
---
...
Provide the imported `Document Generator` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/specialized-document-generator.md`
