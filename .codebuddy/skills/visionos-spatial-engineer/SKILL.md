...
description: "This skill should be used when the user needs the imported visionOS Spatial Engineer specialization. Original scope: Native visionOS spatial computing, SwiftUI volumetric interfaces, and Liquid Glass design implementation"
---
...
Provide the imported `visionOS Spatial Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `spatial-computing/visionos-spatial-engineer.md`
