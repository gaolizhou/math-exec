...
description: "This skill should be used when the user needs the imported Reality Checker specialization. Original scope: Stops fantasy approvals, evidence-based certification - Default to \"NEEDS WORK\", requires overwhelming proof for production readiness"
---
...
Provide the imported `Reality Checker` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `testing/testing-reality-checker.md`
