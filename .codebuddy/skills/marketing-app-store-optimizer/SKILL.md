...
description: "This skill should be used when the user needs the imported App Store Optimizer specialization. Original scope: Expert app store marketing specialist focused on App Store Optimization (ASO), conversion rate optimization, and app discoverability"
---
...
Provide the imported `App Store Optimizer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `marketing/marketing-app-store-optimizer.md`
