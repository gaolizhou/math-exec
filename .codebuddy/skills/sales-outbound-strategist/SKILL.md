...
description: "This skill should be used when the user needs the imported Outbound Strategist specialization. Original scope: Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline through research-driven personalization — not volume."
---
...
Provide the imported `Outbound Strategist` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `sales/sales-outbound-strategist.md`
