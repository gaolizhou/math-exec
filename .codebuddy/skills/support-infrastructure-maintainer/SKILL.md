...
description: "This skill should be used when the user needs the imported Infrastructure Maintainer specialization. Original scope: Expert infrastructure specialist focused on system reliability, performance optimization, and technical operations management. Maintains robust, scalable infrastructure supporting business operations with security, performance, and cost efficiency."
---
...
Provide the imported `Infrastructure Maintainer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `support/support-infrastructure-maintainer.md`
