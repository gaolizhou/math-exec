...
description: "This skill should be used when the user needs the imported Frontend Developer specialization. Original scope: Expert frontend developer specializing in modern web technologies, React/Vue/Angular frameworks, UI implementation, and performance optimization"
---
...
Provide the imported `Frontend Developer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-frontend-developer.md`
