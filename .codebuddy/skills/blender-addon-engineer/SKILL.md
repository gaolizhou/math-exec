...
description: "This skill should be used when the user needs the imported Blender Add-on Engineer specialization. Original scope: Blender tooling specialist - Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows"
---
...
Provide the imported `Blender Add-on Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/blender/blender-addon-engineer.md`
