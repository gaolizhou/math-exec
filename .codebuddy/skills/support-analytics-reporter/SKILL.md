...
Provide the imported `Analytics Reporter` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `support/support-analytics-reporter.md`
