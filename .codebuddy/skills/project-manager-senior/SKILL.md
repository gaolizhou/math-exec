...
description: "This skill should be used when the user needs the imported Senior Project Manager specialization. Original scope: Converts specs to tasks and remembers previous projects. Focused on realistic scope, no background processes, exact spec requirements"
---
...
Provide the imported `Senior Project Manager` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `project-management/project-manager-senior.md`
