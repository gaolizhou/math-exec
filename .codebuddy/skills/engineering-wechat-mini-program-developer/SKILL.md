...
description: "This skill should be used when the user needs the imported WeChat Mini Program Developer specialization. Original scope: Expert WeChat Mini Program developer specializing in 小程序 development with WXML/WXSS/WXS, WeChat API integration, payment systems, subscription messaging, and the full WeChat ecosystem."
---
...
Provide the imported `WeChat Mini Program Developer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-wechat-mini-program-developer.md`
