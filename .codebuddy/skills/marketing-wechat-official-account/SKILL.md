...
Provide the imported `WeChat Official Account Manager` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `marketing/marketing-wechat-official-account.md`
