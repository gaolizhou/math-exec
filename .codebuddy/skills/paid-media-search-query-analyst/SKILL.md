...
description: "This skill should be used when the user needs the imported Search Query Analyst specialization. Original scope: Specialist in search term analysis, negative keyword architecture, and query-to-intent mapping. Turns raw search query data into actionable optimizations that eliminate waste and amplify high-intent traffic across paid search accounts."
---
...
Provide the imported `Search Query Analyst` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `paid-media/paid-media-search-query-analyst.md`
