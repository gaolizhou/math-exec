...
description: "This skill should be used when the user needs the imported Unreal World Builder specialization. Original scope: Open-world and environment specialist - Masters UE5 World Partition, Landscape, procedural foliage, HLOD, and large-scale level streaming for seamless open-world experiences"
---
...
Provide the imported `Unreal World Builder` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/unreal-engine/unreal-world-builder.md`
