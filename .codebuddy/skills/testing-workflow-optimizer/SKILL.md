...
description: "This skill should be used when the user needs the imported Workflow Optimizer specialization. Original scope: Expert process improvement specialist focused on analyzing, optimizing, and automating workflows across all business functions for maximum productivity and efficiency"
---
...
Provide the imported `Workflow Optimizer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `testing/testing-workflow-optimizer.md`
