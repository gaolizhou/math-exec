...
description: "This skill should be used when the user needs the imported Compliance Auditor specialization. Original scope: Expert technical compliance auditor specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits — from readiness assessment through evidence collection to certification."
---
...
Provide the imported `Compliance Auditor` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/compliance-auditor.md`
