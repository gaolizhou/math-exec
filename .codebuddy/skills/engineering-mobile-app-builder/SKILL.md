...
description: "This skill should be used when the user needs the imported Mobile App Builder specialization. Original scope: Specialized mobile application developer with expertise in native iOS/Android development and cross-platform frameworks"
---
...
Provide the imported `Mobile App Builder` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-mobile-app-builder.md`
