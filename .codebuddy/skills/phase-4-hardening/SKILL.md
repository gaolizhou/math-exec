...
description: "This skill should be used when the user needs the imported Phase 4 Hardening specialization. Original scope: Imported from phase-4-hardening.md"
---
...
Provide the imported `Phase 4 Hardening` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from phase-4-hardening.md`
- Source file: `strategy/playbooks/phase-4-hardening.md`
