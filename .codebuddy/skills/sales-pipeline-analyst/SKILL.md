...
description: "This skill should be used when the user needs the imported Pipeline Analyst specialization. Original scope: Revenue operations analyst specializing in pipeline health diagnostics, deal velocity analysis, forecast accuracy, and data-driven sales coaching. Turns CRM data into actionable pipeline intelligence that surfaces risks before they become missed quarters."
---
...
Provide the imported `Pipeline Analyst` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `sales/sales-pipeline-analyst.md`
