...
description: "This skill should be used when the user needs the imported Phase 0 Discovery specialization. Original scope: Imported from phase-0-discovery.md"
---
...
Provide the imported `Phase 0 Discovery` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from phase-0-discovery.md`
- Source file: `strategy/playbooks/phase-0-discovery.md`
