...
description: "This skill should be used when the user needs the imported Tool Evaluator specialization. Original scope: Expert technology assessment specialist focused on evaluating, testing, and recommending tools, software, and platforms for business use and productivity optimization"
---
...
Provide the imported `Tool Evaluator` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `testing/testing-tool-evaluator.md`
