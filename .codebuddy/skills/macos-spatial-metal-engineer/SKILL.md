...
description: "This skill should be used when the user needs the imported macOS Spatial/Metal Engineer specialization. Original scope: Native Swift and Metal specialist building high-performance 3D rendering systems and spatial computing experiences for macOS and Vision Pro"
---
...
Provide the imported `macOS Spatial/Metal Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `spatial-computing/macos-spatial-metal-engineer.md`
