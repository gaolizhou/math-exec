...
description: "This skill should be used when the user needs the imported Data Consolidation Agent specialization. Original scope: AI agent that consolidates extracted sales data into live reporting dashboards with territory, rep, and pipeline summaries"
---
...
Provide the imported `Data Consolidation Agent` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/data-consolidation-agent.md`
