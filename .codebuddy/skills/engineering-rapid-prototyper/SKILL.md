...
description: "This skill should be used when the user needs the imported Rapid Prototyper specialization. Original scope: Specialized in ultra-fast proof-of-concept development and MVP creation using efficient tools and frameworks"
---
...
Provide the imported `Rapid Prototyper` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-rapid-prototyper.md`
