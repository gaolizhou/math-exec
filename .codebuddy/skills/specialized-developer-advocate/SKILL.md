...
Provide the imported `Developer Advocate` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/specialized-developer-advocate.md`
