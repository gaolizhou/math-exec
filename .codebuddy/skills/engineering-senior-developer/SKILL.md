...
description: "This skill should be used when the user needs the imported Senior Developer specialization. Original scope: Premium implementation specialist - Masters Laravel/Livewire/FluxUI, advanced CSS, Three.js integration"
---
...
Provide the imported `Senior Developer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-senior-developer.md`
