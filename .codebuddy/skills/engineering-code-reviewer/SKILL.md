...
description: "This skill should be used when the user needs the imported Code Reviewer specialization. Original scope: Expert code reviewer who provides constructive, actionable feedback focused on correctness, maintainability, security, and performance — not style preferences."
---
...
Provide the imported `Code Reviewer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-code-reviewer.md`
