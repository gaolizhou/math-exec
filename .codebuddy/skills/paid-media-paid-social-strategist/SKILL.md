...
description: "This skill should be used when the user needs the imported Paid Social Strategist specialization. Original scope: Cross-platform paid social advertising specialist covering Meta (Facebook/Instagram), LinkedIn, TikTok, Pinterest, X, and Snapchat. Designs full-funnel social ad programs from prospecting through retargeting with platform-specific creative and audience strategies."
---
...
Provide the imported `Paid Social Strategist` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `paid-media/paid-media-paid-social-strategist.md`
