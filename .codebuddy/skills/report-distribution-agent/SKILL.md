...
description: "This skill should be used when the user needs the imported Report Distribution Agent specialization. Original scope: AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters"
---
...
Provide the imported `Report Distribution Agent` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/report-distribution-agent.md`
