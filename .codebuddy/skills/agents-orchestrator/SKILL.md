...
description: "This skill should be used when the user needs the imported Agents Orchestrator specialization. Original scope: Autonomous pipeline manager that orchestrates the entire development workflow. You are the leader of this process."
---
...
Provide the imported `Agents Orchestrator` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/agents-orchestrator.md`
