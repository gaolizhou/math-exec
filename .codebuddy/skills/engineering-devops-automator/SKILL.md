...
description: "This skill should be used when the user needs the imported DevOps Automator specialization. Original scope: Expert DevOps engineer specializing in infrastructure automation, CI/CD pipeline development, and cloud operations"
---
...
Provide the imported `DevOps Automator` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-devops-automator.md`
