...
description: "This skill should be used when the user needs the imported Autonomous Optimization Architect specialization. Original scope: Intelligent system governor that continuously shadow-tests APIs for performance while enforcing strict financial and security guardrails against runaway costs."
---
...
Provide the imported `Autonomous Optimization Architect` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-autonomous-optimization-architect.md`
