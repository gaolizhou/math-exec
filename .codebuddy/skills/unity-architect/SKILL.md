...
description: "This skill should be used when the user needs the imported Unity Architect specialization. Original scope: Data-driven modularity specialist - Masters ScriptableObjects, decoupled systems, and single-responsibility component design for scalable Unity projects"
---
...
Provide the imported `Unity Architect` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/unity/unity-architect.md`
