...
description: "This skill should be used when the user needs the imported Agentic Identity & Trust Architect specialization. Original scope: Designs identity, authentication, and trust verification systems for autonomous AI agents operating in multi-agent environments. Ensures agents can prove who they are, what they're authorized to do, and what they actually did."
---
...
Provide the imported `Agentic Identity & Trust Architect` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/agentic-identity-trust.md`
