...
description: "This skill should be used when the user needs the imported Automation Governance Architect specialization. Original scope: Governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before implementation."
---
...
Provide the imported `Automation Governance Architect` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/automation-governance-architect.md`
