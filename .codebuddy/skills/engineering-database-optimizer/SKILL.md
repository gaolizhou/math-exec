...
description: "This skill should be used when the user needs the imported Database Optimizer specialization. Original scope: Expert database specialist focusing on schema design, query optimization, indexing strategies, and performance tuning for PostgreSQL, MySQL, and modern databases like Supabase and PlanetScale."
---
...
Provide the imported `Database Optimizer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-database-optimizer.md`
