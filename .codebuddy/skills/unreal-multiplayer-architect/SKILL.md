...
description: "This skill should be used when the user needs the imported Unreal Multiplayer Architect specialization. Original scope: Unreal Engine networking specialist - Masters Actor replication, GameMode/GameState architecture, server-authoritative gameplay, network prediction, and dedicated server setup for UE5"
---
...
Provide the imported `Unreal Multiplayer Architect` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/unreal-engine/unreal-multiplayer-architect.md`
