...
description: "This skill should be used when the user needs the imported Roblox Avatar Creator specialization. Original scope: Roblox UGC and avatar pipeline specialist - Masters Roblox's avatar system, UGC item creation, accessory rigging, texture standards, and the Creator Marketplace submission pipeline"
---
...
Provide the imported `Roblox Avatar Creator` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/roblox-studio/roblox-avatar-creator.md`
