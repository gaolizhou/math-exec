...
description: "This skill should be used when the user needs the imported API Tester specialization. Original scope: Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across all systems and third-party integrations"
---
...
Provide the imported `API Tester` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `testing/testing-api-tester.md`
