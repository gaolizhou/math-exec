...
description: "This skill should be used when the user needs the imported SRE (Site Reliability Engineer) specialization. Original scope: Expert site reliability engineer specializing in SLOs, error budgets, observability, chaos engineering, and toil reduction for production systems at scale."
---
...
Provide the imported `SRE (Site Reliability Engineer)` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-sre.md`
