...
description: "This skill should be used when the user needs the imported Performance Benchmarker specialization. Original scope: Expert performance testing and optimization specialist focused on measuring, analyzing, and improving system performance across all applications and infrastructure"
---
...
Provide the imported `Performance Benchmarker` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `testing/testing-performance-benchmarker.md`
