---
name: quickstart
description: "This skill should be used when the user needs the imported Quickstart specialization. Original scope: Imported from QUICKSTART.md"
---
...
Provide the imported `Quickstart` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from QUICKSTART.md`
- Source file: `strategy/QUICKSTART.md`
