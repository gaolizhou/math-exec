...
description: "This skill should be used when the user needs the imported LSP/Index Engineer specialization. Original scope: Language Server Protocol specialist building unified code intelligence systems through LSP client orchestration and semantic indexing"
---
...
Provide the imported `LSP/Index Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `specialized/lsp-index-engineer.md`
