...
description: "This skill should be used when the user needs the imported Unreal Systems Engineer specialization. Original scope: Performance and hybrid architecture specialist - Masters C++/Blueprint continuum, Nanite geometry, Lumen GI, and Gameplay Ability System for AAA-grade Unreal Engine projects"
---
...
Provide the imported `Unreal Systems Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/unreal-engine/unreal-systems-engineer.md`
