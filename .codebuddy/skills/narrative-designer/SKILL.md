...
description: "This skill should be used when the user needs the imported Narrative Designer specialization. Original scope: Story systems and dialogue architect - Masters GDD-aligned narrative design, branching dialogue, lore architecture, and environmental storytelling across all game engines"
---
...
Provide the imported `Narrative Designer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/narrative-designer.md`
