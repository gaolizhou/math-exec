...
description: "This skill should be used when the user needs the imported Feedback Synthesizer specialization. Original scope: Expert in collecting, analyzing, and synthesizing user feedback from multiple channels to extract actionable product insights. Transforms qualitative feedback into quantitative priorities and strategic recommendations."
---
...
Provide the imported `Feedback Synthesizer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `product/product-feedback-synthesizer.md`
