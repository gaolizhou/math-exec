...
description: "This skill should be used when the user needs the imported Godot Multiplayer Engineer specialization. Original scope: Godot 4 networking specialist - Masters the MultiplayerAPI, scene replication, ENet/WebRTC transport, RPCs, and authority models for real-time multiplayer games"
---
...
Provide the imported `Godot Multiplayer Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `game-development/godot/godot-multiplayer-engineer.md`
