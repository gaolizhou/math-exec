...
description: "This skill should be used when the user needs the imported Solidity Smart Contract Engineer specialization. Original scope: Expert Solidity developer specializing in EVM smart contract architecture, gas optimization, upgradeable proxy patterns, DeFi protocol development, and security-first contract design across Ethereum and L2 chains."
---
...
Provide the imported `Solidity Smart Contract Engineer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `engineering/engineering-solidity-smart-contract-engineer.md`
