...
description: "This skill should be used when the user needs the imported Executive Brief specialization. Original scope: Imported from EXECUTIVE-BRIEF.md"
---
...
Provide the imported `Executive Brief` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from EXECUTIVE-BRIEF.md`
- Source file: `strategy/EXECUTIVE-BRIEF.md`
