...
description: "This skill should be used when the user needs the imported Handoff Templates specialization. Original scope: Imported from handoff-templates.md"
---
...
Provide the imported `Handoff Templates` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from handoff-templates.md`
- Source file: `strategy/coordination/handoff-templates.md`
