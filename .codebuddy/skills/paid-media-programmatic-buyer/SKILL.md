...
description: "This skill should be used when the user needs the imported Programmatic & Display Buyer specialization. Original scope: Display advertising and programmatic media buying specialist covering managed placements, Google Display Network, DV360, trade desk platforms, partner media (newsletters, sponsored content), and ABM display strategies via platforms like Demandbase and 6Sense."
---
...
Provide the imported `Programmatic & Display Buyer` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.
...
- Source file: `paid-media/paid-media-programmatic-buyer.md`
