---
name: nexus-strategy
description: "This skill should be used when the user needs the imported Nexus Strategy specialization. Original scope: Imported from nexus-strategy.md"
---
...
Provide the imported `Nexus Strategy` specialization from `agency-agents` as a CodeBuddy project skill. Apply the role's mission, rules, workflows, deliverables, and success metrics to the current task.

## When to Use

Activate this skill when the user's request matches this source scope:

- `Imported from nexus-strategy.md`
- Source file: `strategy/nexus-strategy.md`
